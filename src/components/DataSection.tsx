...
const DataSection = () => {
  ...
  return <section id="data-analysis" className="section-padding bg-white py-[10px]">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="bg-sightx-purple h-2 rounded-full" style={{
                        width: '85%'
                      }}></div>
                      </div>
                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-center mb-6">
                      <div>
                        ...
                        <div className="flex items-center">
                          <div className="flex">
                            {[1, 2, 3, 4].map(star => <svg key={star} className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <div className="w-48 bg-gray-200 rounded-full h-2">
                          <div className="bg-sightx-green h-2 rounded-full" style={{
                          width: '78%'
                        }}></div>
                        </div>
