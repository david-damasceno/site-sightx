...
const DonnaSection = () => {
  return (
    <section id="donna" className="section-padding py-20">
      <div className="container-custom">
        <div className="section-title">
          <h2>Conheça Donna, sua <span className="gradient-text">assistente estratégica</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
          <div className="space-y-8 order-2 md:order-1">
            <div className="feature-card transition-all duration-300 hover:scale-105">
              <div className="flex items-start gap-4">
                <div className="bg-sightx-purple/10 p-3 rounded-lg">
                  <Bell className="text-sightx-purple h-6 w-6" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Alertas Proativos</h3>
