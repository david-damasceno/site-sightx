  ...
  return (
    <section id="home" className="relative pt-20 pb-16 md:pt-28 md:pb-24 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -left-20 w-64 h-64 bg-blue-200 opacity-10 rounded-full blur-3xl animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/3 w-32 h-32 bg-green-200 opacity-10 rounded-full blur-2xl animate-float" style={{animationDelay: '2s'}}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className={`lg:col-span-5 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{animationDelay: '0.2s'}}>
            ...
            <div className="grid grid-cols-2 gap-3 mb-8 max-w-lg">
              {[
                { icon: TrendingUp, title: "Vendas", desc: "+32% crescimento", color: "from-purple-50 to-purple-100" },
                { icon: Target, title: "Decisões", desc: "Baseadas em dados", color: "from-blue-50 to-blue-100" },
                { icon: Brain, title: "IA personalizada", desc: "Para seu negócio", color: "from-green-50 to-green-100" },
                { icon: BarChart2, title: "Insights", desc: "Em tempo real", color: "from-amber-50 to-amber-100" }
              ].map((item, i) => (
                <div 
                  key={i}
                  className={`flex p-3 bg-gradient-to-br ${item.color} rounded-lg shadow-sm border border-white/80 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 group`}
            ...
            <div className="flex flex-wrap gap-3">
              <Button 
                className="bg-sightx-purple hover:bg-sightx-purple/90 text-white shadow-md transition-all duration-300 hover:translate-y-[-1px] hover:shadow-lg group px-4 py-2 h-auto rounded-lg text-sm"
              >
              ...
              <Button 
                className="border border-sightx-purple text-sightx-purple bg-white/80 backdrop-blur-sm hover:bg-white transition-all duration-300 hover:shadow-md px-4 py-2 h-auto rounded-lg text-sm" 
                asChild
              >
          ...
          <div className={`relative lg:col-span-7 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{animationDelay: '0.4s'}}>
            {/* Modern dashboard with improved aesthetics */}
            <div className={cn(
              "relative bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-gray-100/80 overflow-hidden",
              "transform transition-all duration-500 hover:shadow-[0_15px_35px_rgba(8,_112,_184,_0.2)] hover:translate-y-[-2px]"
            )}>
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-4 gap-2 mb-4">
                  {[
                    { value: "84%", label: "Conversão", color: "from-purple-50 to-purple-100" },
                    { value: "68K", label: "Visitantes", color: "from-blue-50 to-blue-100" },
                    { value: "R$32K", label: "Receita", color: "from-green-50 to-green-100" },
                    { value: "47%", label: "Crescimento", color: "from-amber-50 to-amber-100" }
                  ].map((metric, i) => (
                    <div key={i} className={`bg-gradient-to-br ${metric.color} p-2 rounded-lg flex flex-col items-center`}>
                ...
                <div className="h-36 bg-gray-50/80 rounded-lg mb-4 flex items-center justify-center p-3 relative overflow-hidden">
                  <div className="absolute inset-0">
                    <div className="w-full h-full flex items-end justify-around">
                      {[30, 45, 38, 65, 50, 70, 85, 75].map((height, i) => (
                        <div 
                          key={i}
                          className={`w-[7%] bg-sightx-purple/60 rounded-t-sm transition-all duration-1000 ease-out`}
                          style={{
                  ...
                  <div className="relative z-10 w-full">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex gap-1">
                        <span className="text-[10px] text-white bg-purple-600 px-1.5 py-0.5 rounded">Mensal</span>
                        <span className="text-[10px] text-gray-600 bg-gray-100 px-1.5 py-0.5 rounded">Anual</span>
                      </div>
                    </div>
                    ...
                    <div className="w-full mt-auto">
                      ...
                      <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div 
                          className="h-full bg-gradient-to-r from-purple-400 to-sightx-purple rounded-full transition-all duration-1000 ease-out"
                          style={{
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { icon: Users, title: "Novos clientes", value: "+27% este mês", progress: 65, color: "green-400" },
                    { icon: Database, title: "Insights gerados", value: "48 esta semana", progress: 80, color: "purple-400" }
                  ].map((card, i) => (
                    <div key={i} className="bg-white border border-gray-100 p-2.5 rounded-lg flex items-start gap-2 shadow-sm hover:shadow-md transition-all duration-300">
                      ...
                      <div className="w-full">
                        ...
                        <div className="w-full h-1 bg-gray-100 rounded-full mt-1.5 overflow-hidden">
                          <div 
                            className={`bg-${card.color} h-full rounded-full transition-all duration-1000 ease-out`}
                            style={{
