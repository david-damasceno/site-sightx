        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild className="btn-primary flex items-center gap-2 shadow-float">
          ...
          <div className="relative animate-fade-in-right hidden lg:block">
            <div className="relative bg-white rounded-xl shadow-2xl p-6 z-10 transform hover:scale-[1.02] transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-semibold">Dashboard de Vendas</h3>
                <span className="text-sightx-green font-medium px-2 py-1 bg-green-50 rounded-md">↑ 27%</span>
              </div>
