  ...
  return <footer className="bg-sightx-black text-white pt-16 pb-8">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
            ...
            <div className="mb-6">
              <a href="#" className="flex items-center">
                ...
                <span className="text-2xl font-bold text-white">
                  Sight<span className="text-slate-50">X</span>
                </span>
              </a>
            </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Missão</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Valores</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Carreira</a>
              </li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex items-center text-gray-400 mb-2">
              ...
              <span>contato@sightx.com.br</span>
            </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <button onClick={scrollToTop} className="fixed bottom-8 right-8 bg-sightx-purple p-3 rounded-full shadow-lg hover:bg-sightx-green transition-colors" aria-label="Voltar ao topo">
