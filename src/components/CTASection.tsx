              ...
              {!submitted ? <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="contactName" name="contactName" value={formData.contactName} onChange={handleInputChange} className="input-custom" placeholder="Seu nome" required />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="company" name="company" value={formData.company} onChange={handleInputChange} className="input-custom" placeholder="Sua empresa" required />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} className="input-custom" placeholder="seu@email.com" required />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="whatsapp" name="whatsapp" value={formData.whatsapp} onChange={handleInputChange} className="input-custom" placeholder="(XX) XXXXX-XXXX" required />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.preferredSolution} onValueChange={value => handleSelectChange('preferredSolution', value)}>
                        <SelectTrigger className="input-custom">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="suggestions" name="suggestions" value={formData.suggestions} onChange={handleInputChange} className="input-custom min-h-[80px]" placeholder="Compartilhe suas ideias para novas soluções..." />
                  </div>
                  
                  <div className="flex items-start space-x-2 mt-4">
                    <Checkbox id="acceptTerms" checked={formData.acceptTerms} onCheckedChange={handleCheckboxChange} className="mt-1" />
                    <Label htmlFor="acceptTerms" className="text-xs text-gray-600 font-normal">
