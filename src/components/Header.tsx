    ...
    <header className="fixed top-0 left-0 w-full bg-white/90 backdrop-blur-sm z-50 shadow-sm">
      <div className="container-custom flex justify-between items-center h-20">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#data-analysis" className="font-medium hover:text-sightx-purple transition-colors">
            Análise
          </a>
          <a href="#whatsapp" className="font-medium hover:text-sightx-purple transition-colors">
            WhatsApp
          </a>
